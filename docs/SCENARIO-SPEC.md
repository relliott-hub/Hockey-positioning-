# Scenario Spec — for coach review

Every claim this game makes about hockey positioning, in plain language.
Positions are in feet on a regulation 200 × 85 ft sheet.

**What to check:**

1. Would this situation actually happen in a game?
2. Is the **best** read the one you would teach?
3. Is each **acceptable** read genuinely defensible — something you would not correct a player for?
4. Is each **wrong** read a real mistake, and is the reason given the right reason?

Anything you disagree with, mark it and it gets changed. The game grades
strictly against what is written here, so this document *is* the hockey.

---

## The ice

| Feature | This game | Regulation |
|---|---|---|
| Length | 200 ft | 200 ft |
| Width | 85 ft | 85 ft |
| Goal line from end boards | 11 ft | 11 ft |
| Blue line from end boards | 75 ft | 75 ft |
| Neutral zone | 50 ft | 50 ft |
| Faceoff circle radius | 15 ft | 15 ft |
| End dot from goal line | 20 ft | 20 ft |
| End dot from centre | 22 ft | 22 ft |
| Crease radius | 6 ft | 6 ft |

One foot means the same distance in every direction, so a spacing judgement
across the ice is measured the same way as one up the ice.
...
*Breakout · `breakout_corner_pressure`*

Your defenceman has retrieved the puck in the corner, below your own goal line, with a forechecker closing. The team needs to get out of the zone.

**Puck:** behind your own net, tight to the near boards (8 ft from the end boards, 31 ft near of centre)  
**Carried by:** LD  
...
### Defending the half-wall

*Defend · `dzone_halfwall_coverage`*

The other team has the puck on the half-wall in your end, with both their defencemen up at your blue line. They're looking for a play to the slot.

**Puck:** in your defensive zone, tight to the near boards (30 ft from the end boards, 34 ft near of centre)  
...
*O-zone · `ozone_cycle_support`*

Your winger has the puck in the corner below their goal line and is protecting it on the wall. Keep possession and create a scoring chance.

**Puck:** in the offensive zone, tight to the near boards (195 ft from the end boards, 31 ft near of centre)  
**Carried by:** RW  
**Attacking:** left to right
...
*Rush · `rush_three_on_two`*

Your centre is carrying the puck through the neutral zone with numbers. Two defenders are back and their forwards are behind the play.

**Puck:** in the neutral zone, in the middle of the ice (98 ft from the end boards, 1 ft far of centre)  
**Carried by:** C  
**Attacking:** left to right
...
*Defend · `dzone_corner_battle`*

The other team has the puck deep in your corner, below your goal line, and is trying to get it to the front of the net. Protect the house.

**Puck:** behind your own net, toward the near side (6 ft from the end boards, 29 ft near of centre)  
**Carried by:** an opponent  
**Attacking:** right to left
...
Your defenceman has the puck in the neutral zone and the team is regrouping to attack with speed instead of dumping it in.

**Puck:** in the neutral zone, toward the far side (88 ft from the end boards, 13 ft far of centre)  
**Carried by:** RD  
**Attacking:** left to right
...
| Player | Where |
|---|---|
| RD *(has the puck)* | in the neutral zone, toward the far side (88 ft from the end boards, 13 ft far of centre) |
| LD | in the neutral zone, toward the near side (82 ft from the end boards, 14 ft near of centre) |
| C | in the neutral zone, in the middle of the ice (98 ft from the end boards, 2 ft near of centre) |
| RW | in the neutral zone, toward the near side (108 ft from the end boards, 28 ft near of centre) |
| LW | in the neutral zone, toward the far side (108 ft from the end boards, 27 ft far of centre) |

#### Playing C

**Best read** — in the neutral zone, in the middle of the ice (98 ft from the end boards, 2 ft near of centre)

> Middle lane, curling with speed. You're the outlet who turns a regroup into a rush.
...
## How a choice is graded

A player's placement is judged by **which written read it is nearest to** —
not by any geometric rule. That is deliberate: the previous version scored
positions with distance formulas, and an audit found **35% of the answers it
marked wrong broke none of its own coaching rules**. Every option a player
sees now comes from this document.

| Tier | Score | What the player is told |
|---|---|---|
| Best | 92–100 | The read succeeded, plus the reason it's right |
| Acceptable | 68–78 | "That works" — plus what the stronger read gives you |
| Wrong | 8–38 | The specific mistake, and where they wanted to be |

## How outcomes are decided

Position improves the odds; it does not decide the result.

| Read | Goal | Play stays alive | Lost possession | Goal against |
|---|---|---|---|---|
| Best | 62% | 38% | — | — |
| Acceptable | 24% | 62% | 14% | — |
| Wrong | — | — | 72% | 28% |

A good read creating a goal every single time would teach that being in the
right place guarantees the result, which is not true of the sport.
